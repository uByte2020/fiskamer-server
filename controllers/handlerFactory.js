...
exports.createLogs = (user,model, old_registro ,new_registro, operacao) => {
    Log.create({
        new_registro: new_registro,
        old_registro:old_registro,
        user:user,
        operacao:operacao +" "+ model.modelName.substr(0,model.modelName.length-1)
    })
}
