...
router.get('/solicitacao/', solicitcaoStatisticController.getStatisticSolicitacao)  
router.get('/favoritesService/',favoriteStatisticController.getStatisticFavorite)  
router.get('/fornecedor/',fornecedorStatisticController.getAllStatisticFornecedor)  
