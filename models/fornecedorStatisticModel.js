...
const fornecedorStatisticSchema = new mongoose.Schema({
    fornecedor:{
        ...
        ref: 'users',
        required: ['É requerido o fornecedor na qual os dados estatísticos pertecem'],
    },
    qtTotalService:{
         type: Number,
    ...
    qtActiveService:{
        type: Number,
        required: ['É requerida a quantidade total de servicos activos por fornecedores'],
   },
   qtPendenteService:{
    type: Number,
    required: ['É requerida a quantidade total de servicos activos por fornecedores'],
...
const FornecedorStatistic = mongoose.model('fornecedorstatistics', fornecedorStatisticSchema);
